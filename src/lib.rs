...
mod tests {
    ...
    fn batch_norm_simple_test() {
        ...
        for sample_idx in 0..5 {
            ...
            for _ in 0..20 { // Generate up to 20 characters
                ...
                let epsilon = 1e-8;
                let bnvari_safe = bnvari + Tensor::ones(Shape::new(bnvari.shape.dimensions())) * epsilon;
    ...
    fn test_linear_regression() {
        ...
        println!("Final w: {}, Final b: {} (should be ~2.0, ~1.0)", final_w, final_b);
    ...
    fn test_xor_network() {
        ...
        println!("XOR Results: {:?} (should be close to [0, 1, 1, 0])", test_output.item());
    }
